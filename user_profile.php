	...
	<?php
		...
		<div class='row'>
			...
			<center>
				...
				<ul class='list-group'>
					<li class='list-group-item' title='Username'><strong></strong>$f_name $l_name</strong></li>
					...
					<li class='list-group-item' title='Course'><strong>$course</strong></li>

					<li class='list-group-item' title='Year Graduated'><strong>$grad</strong></li>
     				...
     				echo"
						<div id='own_posts'>
							<div class = 'row'>
								...
								<h4><small style='color: black;'>Update a post on <strong>$post_date</strong></small></h4></div>
								<div class='col-sm-4'>
								</div>
								</div>
								<div class='row'>
								...
								<a href='functions/delete_post.php?post_id=$post_id'style='float:right;'><button class='btn-danger'>Delete</button><a/>
								</div><br><br>
					";
				}
