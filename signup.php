...
<div class="row">
	...
	<div class="col-sm-8">
		<div class="main-content">
			<div class="header">
				<h3 style="text-align: center;"><strong>Join PU Alumni Connect</strong></h3>
				<hr>
			</div>
			<div class="l-part">
				<form action="" method="post">
                    ...
                    <div class="input-group">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                        <input type="text" class="form-control" placeholder="Student ID" name="s_id" required="required">
                    </div><br>
    ...
    <option value="Zimbabwe">Zimbabwe</option>
					...
					<div class="input-group">
						...
						<select class="form-control input-md" name="u_course" required="required">
							<option disabled>Select Course Offered</option>
                            <option>B.Sc. Information Technology</option>
							<option>B.A. Communication Studies</option>
							<option>B.A. Theology and Mission</option>
							<option>B.Sc. Business Administration (Marketing)</option>
							<option>B.Sc. Nursing</option>
							<option>B.Sc. Quantity Surveying and Building Economics</option>
					...
					<div class="input-group">
						...
						<input id="graduation" type="Year" class="form-control" placeholder="Year of Graduation" name="u_grad" required="required">
					</div><br>					<a style="text-decoration: none;float: right;color: #FDB515;" data-toggle="tooltip" title="Signin" href="signin.php"><b>Already have an account?</b></a><br><br>
