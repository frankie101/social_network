								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<form action="recovery.php?id=<?php echo $user_id; ?>" method="post" id="f">
											...
											<pre>Answer the above question, we will ask this if you forgot your <br>password.</pre>
											<br><br>
										</form>
										<?php
											if(isset($_POST['sub'])){
...
<?php
	if(isset($_POST['update'])){
		...
		$update = "update users set f_name='$f_name', l_name='$l_name', user_name='$u_name', describe_user='$describe_user', Relationship='$Relationship_status', user_pass='$u_pass', user_country='$u_country' where user_id='$user_id'";
